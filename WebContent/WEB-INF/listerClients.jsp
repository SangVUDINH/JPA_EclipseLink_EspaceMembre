        ...
        <c:choose>
            ...
            <table>
                ...
                <tr class="${boucle.index % 2 == 0 ? 'pair' : 'impair'}">
                    ...
                    <td><c:out value="${ mapClients.value.nomClient }"/></td>
                    <td><c:out value="${ mapClients.value.prenomClient }"/></td>
                    <td><c:out value="${ mapClients.value.adresseClient }"/></td>
                    <td><c:out value="${ mapClients.value.telephoneClient }"/></td>
                    <td><c:out value="${ mapClients.value.emailClient }"/></td>
